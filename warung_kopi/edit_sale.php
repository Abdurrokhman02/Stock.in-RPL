<?php
  ...
  // Periksa level pengguna yang memiliki izin untuk mengakses halaman ini
  page_require_level(3);
?>
<?php
$sale = find_by_id('sales',(int)$_GET['id']);
if(!$sale){
  $session->msg("d","ID produk penjualan tidak ditemukan.");
  redirect('sales.php');
}
?>
    ...
    validate_fields($req_fields);
        if(empty($errors)){
          ...
          if( $result && $db->affected_rows() === 1){
                    ...
                    $session->msg('s',"Data penjualan berhasil diperbarui.");
  ...
  <div class="panel">
    <div class="panel-heading clearfix">
      <strong>
        ...
        <span>Edit Data Penjualan</span>
     </strong>
     <div class="pull-right">
       <a href="sales.php" class="btn btn-primary">Lihat Semua Penjualan</a>
     </div>
    </div>
          ...
          <th> Aksi </th>
           ...
           <tbody  id="product_info">
              ...
              <form method="post" action="edit_sale.php?id=<?php echo (int)$sale['id']; ?>">
                ...
                <td>
                  <button type="submit" name="update_sale" class="btn btn-primary">Perbarui</button>
                </td>
              </form>
              </tr>
           </tbody>
