<?php
  $page_title = 'Semua Grup';
  require_once('includes/load.php');
  // Memeriksa level pengguna yang memiliki izin untuk melihat halaman ini
  ...
  <div class="col-md-12">
    ...
    <div class="panel-heading clearfix">
      <strong>
       ...
       <a href="add_group.php" class="btn btn-info pull-right btn-sm"> Tambah Grup Baru</a>
    </div>
