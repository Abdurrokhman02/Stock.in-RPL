...
if(isset($_POST['submit'])){
  ...
  $session->msg("d", "Pilih tanggal terlebih dahulu");
  redirect('sales_report.php', false);
}
?>
<!doctype html>
...
<body>
  <?php if($results): ?>
    <div class="page-break">
       <div class="sale-head">
           <h1>Sistem Manajemen Inventaris - Laporan Penjualan</h1>
           <strong><?php if(isset($start_date)){ echo $start_date;}?> SAMPAI TANGGAL <?php if(isset($end_date)){echo $end_date;}?> </strong>
       </div>
  ...
  <?php
        ...
        $session->msg("d", "Maaf, tidak ditemukan data penjualan.");
        redirect('sales_report.php', false);
     endif;
  ?>
</body>
